    ...
    card.innerHTML = `
        ...
        <div class="mt-4 pt-4 border-t border-white/10">
            <div class="flex gap-2">
                <button class="template-edit-btn flex-1 px-3 py-2 bg-gray-600/50 hover:bg-gray-600 text-white text-sm rounded-lg transition-colors flex items-center justify-center gap-2" ${isComingSoon ? 'disabled' : ''}>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button class="template-deploy-btn flex-1 px-3 py-2 bg-[#F15F22] hover:bg-[#F15F22]/80 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2" ${isComingSoon ? 'disabled' : ''}>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
