...
1. Create a new RAG collection
2. Prepare SQL examples with user queries
3. Populate the collection via the API
4. Enable the collection for use
...
def main():
    ...
    if result and result.get("status") == "success":
        ...
        print("=" * 70)
        print("\nNext steps:")
        print(f"1. Enable the collection: POST {args.server}/api/v1/rag/collections/{args.collection_id}/toggle")
        print(f"2. View cases: GET {args.server}/api/v1/rag/collections/{args.collection_id}/rows")
        print("3. Start querying - the agent will use these examples!")
        return 0
    else:
        print("\n" + "=" * 70)
