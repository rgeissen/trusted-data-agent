...
PROVIDER_SYSTEM_PROMPTS = {
    ...
    "Anthropic": MASTER_SYSTEM_PROMPT if MASTER_SYSTEM_PROMPT else DEFAULT_FALLBACK_SYSTEM_PROMPT,
    "Amazon": MASTER_SYSTEM_PROMPT if MASTER_SYSTEM_PROMPT else DEFAULT_FALLBACK_SYSTEM_PROMPT,
    "OpenAI": MASTER_SYSTEM_PROMPT if MASTER_SYSTEM_PROMPT else DEFAULT_FALLBACK_SYSTEM_PROMPT,
    "Azure": MASTER_SYSTEM_PROMPT if MASTER_SYSTEM_PROMPT else DEFAULT_FALLBACK_SYSTEM_PROMPT,
    "Friendli": MASTER_SYSTEM_PROMPT if MASTER_SYSTEM_PROMPT else DEFAULT_FALLBACK_SYSTEM_PROMPT,
